...
export const Logout = ({ handleLogin }: Props) => {
    ...
    return (
        <form className="user_login" onSubmit={handleEnter} >
            <label htmlFor="name">nombre: <span style={{ fontSize: 'small' }} >min 5 caracteres</span> </label>
            ...
            <label htmlFor="cody">codigo de verifación:
                <span style={{ color: 'yellow', padding: '0 5px', backgroundColor: 'GrayText' }} >  revice su bandeja de entrada gmail para abtener el codigo de
                    verifación</span>
            </label>
